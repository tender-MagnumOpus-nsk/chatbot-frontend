...
export const ResponsePage: FC = () => {
  ...
  return (
    <div className={s.ResponsePage}>
      ...
      <Text variant={ETextVariants.BODY_S_REGULAR} style={{ marginBottom: '16px' }}>
        <i>
          {isMobile
            ? '(Можно нажать на элемент для получения подробной информации)'
            : '(Можно нажать на строку таблицы для получения подробной информации)'}
        </i>
      </Text>
